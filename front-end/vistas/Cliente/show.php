...
<form class="needs-validation" novalidate action="../../../back-end/controladores/cliente_controlador.php" method="POST" enctype="multipart/form-data" style="color:#fff;">
    ...
    <div class="form-row">
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="nombre" id="Nombre" maxlength="45" readonly value="<?php echo $cli->Nombre ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="apellidoP"  maxlength="45" readonly value="<?php echo $cli->ApellidoP ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="apellidoM"  maxlength="45" readonly value="<?php echo $cli->ApellidoM ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="direccion" id="Nombre" maxlength="45" readonly value="<?php echo $cli->Direccion ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="ciudad"  maxlength="45" readonly value="<?php echo $cli->Ciudad ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="codPostal"  maxlength="45" readonly value="<?php echo $cli->CodPostal ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-3 mb-1">
            ...
            <input type="tel" class="form-control" id="validationCustom02" name="telefono"  maxlength="45" readonly value="<?php echo $cli->Telefono ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
