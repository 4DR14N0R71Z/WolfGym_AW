...
<form class="needs-validation" novalidate action="../../../back-end/controladores/coach_controlador.php" method="POST" enctype="multipart/form-data" style="color:#fff;">
    ...
    <div class="form-row">
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="nombre" id="Nombre" maxlength="45" required value="<?php echo $coa->Nombre ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="apellidoP"  maxlength="45" required value="<?php echo $coa->ApellidoP ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="apellidoM"  maxlength="45" required value="<?php echo $coa->ApellidoM ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="direccion" id="Nombre" maxlength="45" required value="<?php echo $coa->Direccion ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="ciudad"  maxlength="45" required value="<?php echo $coa->Ciudad ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
        <div class="col-md-3 mb-1">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="codPostal"  maxlength="45" required value="<?php echo $coa->CodPostal ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-3 mb-1">
            ...
            <input type="tel" class="form-control" id="validationCustom02" name="telefono"  maxlength="45" required value="<?php echo $coa->Telefono ?>">
            <div class="valid-feedback">
                Correcto!
            </div>
        </div>
