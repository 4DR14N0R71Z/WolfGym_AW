    ...
    <form class="needs-validation" novalidate action="../../../back-end/controladores/actividad_controlador.php" method="POST" enctype="multipart/form-data" style="color:#fff;">
        ...
        <div class="form-row">
            <div class="col-md-6 mb-1">
                ...
                <input type="number" class="form-control" id="validationCustom01" name="codigo" id="Codigo" maxlength="20" readonly>
        ...
        <div class="form-row">
            ...
            <div class="col-md-3 mb-1">
                ...
                <input type="text" class="form-control" id="validationCustom02" name="descripcion" id="Apellidos" maxlength="45" required>
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="col-md-3 mb-1">
                ...
                <select class="custom-select" id="validationCustom04" name="coach" id="" required>
                    ...
                    ?>
                        <option value="<?php echo $coa->Codigo; ?>"><?php echo $coa->Nombre;
                                                                    echo " ";
                                                                    echo $coa->ApellidoP; ?></option> <?php  ?>
                    <?php
                    endforeach;
                    ?>
                </select>
            ...
            <div class="col-md-3 mb-1">
                ...
                <input type="date" class="form-control" id="validationCustom02" name="fecha" id="Apellidos" maxlength="45" required>
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="col-md-3 mb-1">
                ...
                <input type="time" class="form-control" id="validationCustom02" name="inicio" id="Apellidos" maxlength="45" required>
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
            <div class="col-md-3 mb-1">
                ...
                <input type="time" class="form-control" id="validationCustom02" name="termino" id="Apellidos" maxlength="45" required>
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
