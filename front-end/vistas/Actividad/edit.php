    ...
    <form class="needs-validation" novalidate action="../../../back-end/controladores/actividad_controlador.php" method="POST" enctype="multipart/form-data" style="color:#fff;">
        ...
        <div class="form-row">
            <div class="col-md-3 mb-1">
                ...
                <input type="text" class="form-control" id="validationCustom01" name="nombre" id="Nombre" maxlength="45" required value="<?php echo $act->Nombre ?>">
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
            <div class="col-md-3 mb-1">
                ...
                <input type="text" class="form-control" id="validationCustom02" name="descripcion" id="Apellidos" maxlength="45" required value=" <?php echo $act->Descripcion ?>">
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="col-md-3 mb-1">
                ...
                <select class="custom-select" id="validationCustom04" name="coach" id="" required>
            ...
            <div class="col-md-3 mb-1">
                ...
                <input type="date" class="form-control" id="validationCustom02" name="fecha" id="Apellidos" maxlength="45" required value="<?php echo $act->Fecha ?>">
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="col-md-3 mb-1">
                ...
                <input type="time" class="form-control" id="validationCustom02" name="inicio" id="Apellidos" maxlength="45" required value="<?php echo $act->Inicio ?>">
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
            <div class="col-md-3 mb-1">
                ...
                <input type="time" class="form-control" id="validationCustom02" name="termino" id="Apellidos" maxlength="45" required value="<?php echo $act->Termino ?>">
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
